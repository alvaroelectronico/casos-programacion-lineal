...
El modelo se ha construido y resuelto en la hoja de cálculo \texttt{modelo\_panaderia.xlsx} utilizando el complemento Solver de Excel.

\textbf{Modelo en Excel}

El modelo en Excel se puede construir como el que se muestra en la figura \ref{fig:model_excel_panaderia}.

\begin{figure}[!h]
\caption{modelo en Excel.}
\centering
\includegraphics[width=14cm]{recursos/figs/panaderia/modelo_excel_panaderia.png}
\label{fig:model_excel_panaderia}
\end{figure}

Y la configuración del solver es la que se muestra en la figura \ref{fig:solver_excel_panaderia}.
...
\newpage
\textbf{Resultados en Excel}

La hoja de resultados (informe de respuestas) que proporciona Excel es la de la figura \ref{fig:respuestas_excel_panaderia}.

\begin{figure}[!h]
\caption{resultados (Excel).}
\centering
\includegraphics[width=13cm]{recursos/figs/panaderia/respuestas_excel_panaderia.png}
\label{fig:respuestas_excel_panaderia}
\end{figure}

La hoja de análisis de sensibilidad que proporciona Excel es la de la figura \ref{fig:sensibilidad_excel_panaderia}.

\begin{figure}[!h]
\caption{análisis de sensibilidad (Excel).}
\centering
\includegraphics[width=13cm]{recursos/figs/panaderia/sensibilidad_excel_panaderia.png}
\label{fig:sensibilidad_excel_panaderia}
\end{figure}

Los valores 1E+30 en Excel se refieren a $\infty$; Excel muestra el valor más grande que admite una fórmula en lugar del símbolo de infinito.
...
En Excel, los extremos de los intervalos se obtienen a partir del valor original menos el valor "Permisible Reducir" para el extremo inferior y más el valor "Permisible Aumentar" para el extremo superior. En el caso de $b_1$, 137.15 se obtiene como 400 - 262.85 y 480 como 400 + 80 (figura \ref{fig:sensibilidad_excel_panaderia2}).

\begin{figure}[!h]
\caption{análisis de sensibilidad (Excel): cálculo de los extremos del intervalo de $b_1$.}
\centering
\includegraphics[width=13cm]{recursos/figs/panaderia/sensibilidad_excel_panaderia2.png}
\label{fig:sensibilidad_excel_panaderia2}
\end{figure}
